...
class Student:
    ...
    def calculate_final_score(self):
        self.final_score = (
            self.theory_score * 0.2
            + self.practice_score * 0.3
            + self.project_score * 0.5
        )
...
class StudentManager:
    ...
    def show_all(self):
        ...
        for student in self.students:
            print(
                f"{student.id:<10}"
                f"{student.name:<25}"
                f"{student.theory_score:<10}"
                f"{student.practice_score:<10}"
                f"{student.project_score:<10}"
                f"{student.final_score:<12.2f}"
                f"{student.academic_rank:<15}"
            )
    ...
    def delete_student(self):
        id = input("Nhập mã sinh viên cần xóa: ").strip()
